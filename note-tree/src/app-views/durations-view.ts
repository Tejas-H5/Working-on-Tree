...
// }
//
// function recomputeDurations(s: DurationsViewState, noteTree: NoteTree) {
//     recomputeAllNoteDurations(state, noteTree, s.activitiesFrom, s.activitiesTo);
//
//     const numDays = getNumDays(s);
//
//     s.hltMap = [];
...
//             if (nId) {
//                 const note = getNote(noteTree, nId);
...
//         s.noteJumpedFromId = noteTree.currentNoteId;
//     }
//
