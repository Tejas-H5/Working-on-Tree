...
import { EL_A, EL_B, EL_I, EL_PRE, EL_S, EL_U, imElBlock, imElEnd } from "src/utils/im-dom";

// no imBeginX() convention here due to verbosity.
export function imB(c: ImCache) { return imElBlock(c, EL_B); }
export function imBEnd(c: ImCache) { return imElEnd(c, EL_B); }
export function imI(c: ImCache) { return imElBlock(c, EL_I); }
export function imIEnd(c: ImCache) { return imElEnd(c, EL_I); }
export function imU(c: ImCache) { return imElBlock(c, EL_U); }
export function imUEnd(c: ImCache) { return imElEnd(c, EL_U); }
export function imA(c: ImCache) { return imElBlock(c, EL_A); }
export function imAEnd(c: ImCache) { return imElEnd(c, EL_A); }
export function imS(c: ImCache) { return imElBlock(c, EL_S); }
export function imSEnd(c: ImCache) { return imElEnd(c, EL_S); }
export function imPre(c: ImCache) { return imElBlock(c, EL_PRE); }
